...
ActiveRecord::Schema.define(version: 2022_04_26_011243) do
  ...
  create_table "approvals", force: :cascade do |t|
    ...
    t.index ["pair_id"], name: "index_approvals_on_pair_id"
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pair_id"], name: "index_tasks_on_pair_id"
  ...
  add_foreign_key "approvals", "pairs"
